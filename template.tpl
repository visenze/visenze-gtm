...
const paramsMap = {
  staging: {
    sbi: {
      widgetUrl: 'https://cdn-staging.visenze.com/widgets/dist/js/productsearch/staging/staging.deploy_script.3.0.0.js',
...
const initWidget = () => {
  ...
  const failureFn = () => {
    logWithError({ msg: 'unable to load widget script', url: widgetUrl });
    data.gtmOnFailure();
  };

  log({ url: widgetUrl, deployScriptEndpoint: deployScriptUrl, appKey: appKey, productId: productId });
